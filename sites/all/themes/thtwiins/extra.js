...
$(function(){
     jQuery('.field-name-field-imagen-casco').click(function(e) {
       ...
       // jQuery(this).parent().find(".field-name-field-compatibilidad").hide().animate({width: 'toggle'});
  ...
  //$marginLefty.slideToggle();
   ...
   /*
       $(".form-item-field-marca-tid option[value=All]").remove();
       $(".form-item-field-marca-tid option[value=13]").click(
                
            function(e){
                alert("CLIIIICK");
                window.location.replace("node/add/sugerencia-de-casco/fields");}   
            );
 */
});
